...
// WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
import { GreetingController } from "./../app/controller/greeting-controller";
...
const models: TsoaRoute.Models = {
  HelloResponse: {
    dataType: "refObject",
    properties: {
      hiBack: { dataType: "string", required: true },
    },
  ...
  HelloRequest: {
    dataType: "refObject",
    properties: {
      hi: { dataType: "string", required: true },
    },
    additionalProperties: false,
  },
  // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
...
export function RegisterRoutes(app: express.Router) {
  ...
  app.get(
    "/api/v1/greeting/hi",
    ...fetchMiddlewares<RequestHandler>(GreetingController),
    ...fetchMiddlewares<RequestHandler>(GreetingController.prototype.hi),

    function GreetingController_hi(request: any, response: any, next: any) {
      const args = {};
      ...
      try {
        ...
        const promise = controller.hi.apply(controller, validatedArgs as any);
  ...
  app.post(
    ...
    ...fetchMiddlewares<RequestHandler>(GreetingController),
    ...fetchMiddlewares<RequestHandler>(GreetingController.prototype.hello),

    function GreetingController_hello(request: any, response: any, next: any) {
      const args = {
        request: { in: "body", name: "request", required: true, ref: "HelloRequest" },
      };
